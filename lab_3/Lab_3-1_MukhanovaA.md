...
|----------|-----------------|------------|
| **Базовый** | 1,800 руб./мес | Только окупаемость инфраструктуры |
| **Стандартный** | 2,500 руб./мес | Окупаемость + 15% рентабельности |
| **Премиум** | 3,500 руб./мес | Полная окупаемость с запасом |
| **Корпоративный** | 4,500 руб./мес | Включает кастомные отчеты и API |

**Оптимальная стратегия ценообразования:**
- **2,500-3,000 руб./мес** за курс
